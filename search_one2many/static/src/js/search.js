odoo.define('rp_search_one2many_v12.search_section_and_note_backend', function (require) {
    ...
    var SectionAndNoteListRenderer = ListRenderer.extend({
        ...
        _renderView: function () {
            var self = this;
            var def = this._super();
            //console.log(self.arch)
            self.$('.o_list_table').addClass('o_section_and_note_list_view');
            //console.log(self.arch.tag == 'tree' && self.$el.hasClass('o_list_view'))
    ...
    var xx={SectionAndNoteListRenderer: SectionAndNoteListRenderer,SectionAndNoteFieldOne2Many: SectionAndNoteFieldOne2Many};
    return xx
});